using PeacockBook.web.Core.Mapping;
using PeacockBook.web.Core.Models;
using PeacockBook.web.Data;
using PeacockBook.web.Helpers;
using PeacockBook.web.Seeds;
using PeacockBook.web.Services;
using PeacockBook.web.settings;
...
builder.Services.AddDataProtection().SetApplicationName(nameof(PeacockBook));
