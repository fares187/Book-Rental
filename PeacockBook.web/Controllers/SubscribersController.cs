...
using PeacockBook.web.Core.ViewModel;
using PeacockBook.web.Data;

using PeacockBook.web.Filter;
using PeacockBook.web.Migrations;
using PeacockBook.web.Services;
...
namespace PeacockBook.web.Controllers
{
    ...
    public class SubscribersController : Controller
    {
        ...
        public SubscribersController(ApplicationDbContext context, IMapper mapper, IImageService imageService, IDataProtectionProvider dataProtectionProvider, IEmailSender emailSender = null, IEmailBodyBuilder emailBodyBuilder = null, IBackgroundTaskQueue queue = null)
        {
            _context = context;
            _mapper = mapper;
